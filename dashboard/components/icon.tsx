...
const icons: Record<IconName, (props: { className?: string }) => React.ReactNode> = {
  ...
  film: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M2 8h20M2 12h20M2 16h20M8 4v16M16 4v16" />
    </svg>
  ),
  brain: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a5 5 0 0 1 4.5 2.8A4 4 0 0 1 20 8.5a4.5 4.5 0 0 1-.8 8.5A3.5 3.5 0 0 1 16 20H8a3.5 3.5 0 0 1-3.2-3A4.5 4.5 0 0 1 4 8.5a4 4 0 0 1 3.5-3.7A5 5 0 0 1 12 2z" />
      <path d="M12 2v20" />
    </svg>
  ),
  youtube: ({ className }) => (
